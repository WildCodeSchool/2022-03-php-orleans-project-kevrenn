...
INSERT INTO `workshop` (`name`, `description`)VALUES ('Atelier langue bretonne', "La langue bretonne est parlée dans la partie ouest d'une ligne allant de Vannes à Saint-Brieuc. La langue bretonne est enseignée à Orléans :La Kevrenn Orleañs organise des cours pour les débutants. Ils sont assurés par Alan à la Maison des Provinces les lundis de 18h à 19h30.");
...
('','Mariage Germignonville',DATE '2022-04-09','Le Mariage Germignonville',"Château d'Orléans"),
